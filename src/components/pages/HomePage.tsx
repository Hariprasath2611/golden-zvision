  ...
  return (
    <section className="relative w-full min-h-screen bg-background flex flex-col justify-between overflow-hidden">
          ...
          <div className="lg:col-span-8">
            <AnimatedElement delay={200}>
              <h1 className="font-heading text-6xl md:text-8xl lg:text-9xl font-bold leading-[0.9] tracking-tighter text-secondary mb-8">
                DIGITAL<br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-orange-600">REALITY</span><br />
                ARCHITECTS
              </h1>
            </AnimatedElement>
      ...
      <div className="relative z-10 border-t border-secondary/10 bg-background/80 backdrop-blur-sm">
        <div className="overflow-hidden py-4 whitespace-nowrap flex">
